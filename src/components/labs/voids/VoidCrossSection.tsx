  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col sm:flex-row justify-between items-center bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-gray-200 dark:border-slate-700">
        ...
        <div className="flex items-center gap-2 bg-white dark:bg-slate-900 p-1.5 rounded-lg border border-gray-200 dark:border-slate-700 shadow-sm mt-4 sm:mt-0">
          <button
      ...
      <div className="flex gap-4">
        <div className="flex-1 bg-slate-900 h-80 rounded-xl overflow-hidden relative border-2 border-slate-700 shadow-inner">
